#!/bin/bash
#SBATCH --job-name=01_50_      # Job name
...
#SBATCH --output=01_50_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e 01_50_%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_tube_TV.py 50 poiseuille_flow_50_62_62_vs_2e-05_init.gsd 100001 
