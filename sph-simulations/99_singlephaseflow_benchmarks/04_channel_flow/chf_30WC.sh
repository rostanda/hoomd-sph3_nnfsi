...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_channel_flow.py 30 channel_flow_30_42_42_vs_3.3333333333333335e-05_init.gsd 100001 