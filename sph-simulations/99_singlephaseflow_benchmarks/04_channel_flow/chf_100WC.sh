...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_channel_flow.py 100 channel_flow_100_112_112_vs_1e-05_init.gsd 100001 