#!/bin/bash
#SBATCH --job-name=04_100_      # Job name
...
#SBATCH --output=04_100_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e 04_100_%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_channel_flow_TV.py 100 channel_flow_100_112_112_vs_1e-05_init.gsd 100001 