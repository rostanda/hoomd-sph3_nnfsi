#!/bin/bash
#SBATCH --job-name=04_50_      # Job name
...
#SBATCH --output=04_50_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e 04_50_%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_channel_flow_TV.py 50 channel_flow_50_62_62_vs_2e-05_init.gsd 100001 