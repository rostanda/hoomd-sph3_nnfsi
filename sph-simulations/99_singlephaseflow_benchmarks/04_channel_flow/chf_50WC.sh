...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_channel_flow.py 50 channel_flow_50_62_62_vs_2e-05_init.gsd 100001 