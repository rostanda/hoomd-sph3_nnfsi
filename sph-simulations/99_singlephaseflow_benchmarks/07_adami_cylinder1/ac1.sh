...
#SBATCH --output=ac1_%j.log         # Path to the standard output and error files relative to the working directory
#SBATCH --error=ac1_%j.err          # Path to the standard error file
...
/usr/local.nfs/software/openmpi/5.0.1_gcc-12.2_cuda-12.3/bin/mpirun -np 4 python3 run_adami_cylinder1.py 100 "${INIT}"
popd > /dev/null
