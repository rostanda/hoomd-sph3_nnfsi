#!/bin/bash
#SBATCH --job-name=bcc_2em06             # Job name
...
#SBATCH --output=bcc_2em06_%j.log         # Path to the standard output and error files relative to the working directory
#SBATCH --error=bcc_2em06_%j.err          # Path to the standard error file
