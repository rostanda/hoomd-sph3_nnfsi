#!/bin/bash
#SBATCH --job-name=bcc_1em04             # Job name
...
#SBATCH --output=bcc_1em04_%j.log         # Path to the standard output and error files relative to the working directory
#SBATCH --error=bcc_1em04_%j.err          # Path to the standard error file
...
echo "── fx = ${FX} m/s²   (Re_Darcy ≈ 1.5 — onset zone) ──"
