#!/bin/bash
#SBATCH --job-name=bcc_1em02             # Job name
...
#SBATCH --output=bcc_1em02_%j.log         # Path to the standard output and error files relative to the working directory
#SBATCH --error=bcc_1em02_%j.err          # Path to the standard error file
