#!/bin/bash
#SBATCH --job-name=bcc_5em04             # Job name
...
#SBATCH --output=bcc_5em04_%j.log         # Path to the standard output and error files relative to the working directory
#SBATCH --error=bcc_5em04_%j.err          # Path to the standard error file
...
echo "── fx = ${FX} m/s²   (Re_Darcy ≈ 7.7 — expect k_norm < 1.0) ──"
