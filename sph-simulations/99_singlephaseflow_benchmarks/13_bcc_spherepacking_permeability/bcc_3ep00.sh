#!/bin/bash
#SBATCH --job-name=bcc_3ep00             # Job name
...
#SBATCH --output=bcc_3ep00_%j.log         # Path to the standard output and error files relative to the working directory
#SBATCH --error=bcc_3ep00_%j.err          # Path to the standard error file
