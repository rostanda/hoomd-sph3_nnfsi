...
#SBATCH --output=bcc_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e bcc_%j.err # File to which STDERR will be written
