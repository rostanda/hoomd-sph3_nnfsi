#!/bin/bash
#SBATCH --job-name=03_50_      # Job name
...
#SBATCH --output=03_50_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e 03_50_%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_couette_flow_TV.py 50 couette_flow_50_58_17_vs_2e-05_init.gsd 100001 