#!/bin/bash
#SBATCH --job-name=03_30_      # Job name
...
#SBATCH --output=03_30_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e 03_30_%j.err # File to which STDERR will be written
...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_couette_flow_TV.py 30 couette_flow_30_38_17_vs_3.3333333333333335e-05_init.gsd 100001 