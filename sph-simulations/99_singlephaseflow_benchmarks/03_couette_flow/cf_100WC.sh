...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_couette_flow.py 100 couette_flow_100_108_17_vs_1e-05_init.gsd 100001 