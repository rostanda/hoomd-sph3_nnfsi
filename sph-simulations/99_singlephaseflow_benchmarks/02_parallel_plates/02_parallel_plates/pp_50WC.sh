...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_parallel_plates.py 50 parallel_plates_50_62_17_vs_2e-05_init.gsd 500001 