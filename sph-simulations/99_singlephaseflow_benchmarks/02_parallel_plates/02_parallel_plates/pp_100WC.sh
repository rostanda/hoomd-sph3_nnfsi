...
/usr/local.nfs/software/openmpi/4.1.4_gcc-11.3_cuda-11.7/bin/mpirun -np $SLURM_NTASKS  ./run_parallel_plates.py 100 parallel_plates_100_112_17_vs_1e-05_init.gsd 500001 