...
#SBATCH --output=sb_3_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e sb_3_%j.err # File to which STDERR will be written
...
mpirun -np $SLURM_NTASKS ./sphere_in_box_run.py 3.0
