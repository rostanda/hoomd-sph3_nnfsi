#!/bin/bash
#SBATCH --job-name=sb_1000      # Job name
...
#SBATCH --output=sb_1000_%j.log     # Path to the standard output and error files relative to the working directory
...
#SBATCH -e sb_1000_%j.err # File to which STDERR will be written
...
mpirun -np $SLURM_NTASKS ./sphere_in_box_run.py 1000.0
