...
echo "── Case 5  theta=135deg  NL=${NL}  steps=${STEPS} ──"
/usr/local.nfs/software/openmpi/5.0.1_gcc-12.2_cuda-12.3/bin/mpirun -np 4 python3 run_capillary_rise.py ${NL} "${INIT}" 5 ${STEPS}
popd > /dev/null
