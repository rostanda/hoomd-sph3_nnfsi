...
#include "hoomd/sph/SPHIntegratorTwoStep.h"
#include "hoomd/sph/VelocityVerletBasic.h"
...
/*    std::shared_ptr<Thermostat> tstat_1(
    ...
    std::shared_ptr<VelocityVerletBasic> two_step_nve_1(
        new VelocityVerletBasic(sysdef_1, group_all_1));
    std::shared_ptr<VelocityVerletBasic> two_step_nve_2(
        new VelocityVerletBasic(sysdef_2, group_all_2));

    Scalar deltaT = 0.001;
    std::shared_ptr<SPHIntegratorTwoStep> nve_up_1(new SPHIntegratorTwoStep(sysdef_1, deltaT));
    std::shared_ptr<SPHIntegratorTwoStep> nve_up_2(new SPHIntegratorTwoStep(sysdef_2, deltaT));
