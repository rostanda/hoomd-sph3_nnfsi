...
class PYBIND11_EXPORT ForceCompute : public Compute
    ...
    */
    ...
    //! Get the array of computed Ratedpes
    const GPUArray<Scalar4>& getRateDPEArray() const
        {
        return m_ratedpe;
        }
...
class PYBIND11_EXPORT LocalForceComputeData : public GhostLocalDataAccess<Output, ForceCompute>
    ...
    Output getRateDPE(GhostDataFlag flag)
        {
        return this->template getLocalBuffer<Scalar4, Scalar>(m_ratedpe_handle,
                                                         &ForceCompute::getRateDPEArray,
                                                         flag,
                                                         m_buffers_writeable,
                                                         0,
                                                         3 * sizeof(Scalar));
